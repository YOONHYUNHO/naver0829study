...
<body>
  ...
  style="position: absolute; left: 600px; top: 50px; max-width: 300px;"><!-- error가 발생하면 안보이게 처리  onerror = "this.style.diplay = 'none'" -->
        ...
        <tr>
          ...
          <td class="input-group">
	          ...
	          <input type="file" name="upload" id="upload" style="display: none">
	            &nbsp;&nbsp; <!-- 카메라 아이콘 --> 
	            <i class="bi bi-camera-fill uploadcamera"></i></td>
        </tr>
        <tr>
          <th width="100">내용</th>
